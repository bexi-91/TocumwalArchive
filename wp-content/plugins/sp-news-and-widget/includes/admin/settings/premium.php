				...
				<!--Upgrad to Pro HTML -->
					<div id="postbox-container-1" class="postbox-container wpos-sidebar">
						<div class="wpos-epb-wrap">
							...
							<a class="button-yellow" style="margin-bottom:0px;" href="<?php echo WPNW_SITE_LINK; ?>/pricing/?utm_source=WP&utm_medium=News&utm_campaign=EPB-Upgrade-PRO" target="_blank">Know More</a>
						</div>
