							...
							<div class="inside">
								<table class="form-table">
									<tbody>
										<tr>
											<td>
												<p><?php _e('Check design and best solutions for your website.', 'sp-news-and-widget'); ?></p> <br/>												
												<a class="button button-primary" href="<?php echo WPNW_SITE_LINK; ?>/pricing/?utm_source=WP&utm_medium=News&utm_campaign=Check-Designs-Solutions" target="_blank"><?php _e('Check Design & Solution', 'sp-news-and-widget'); ?></a>
											</td>
										</tr>											
									</tbody>
								</table>
