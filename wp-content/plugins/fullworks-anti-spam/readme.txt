...
Tags: anti-spam, antispam, spam, comments, contact form
Tested up to: 5.7
Stable tag: 1.2.4
License: GPLv3 or later
License URI: http://www.gnu.org/licenses/gpl-3.0.html

WordPress anti spam plugin that eliminates automated comment spam without reCAPTHCA or quizes. The ultimate in spam protection.

== Description ==

Fed up with being overwhelmed with wp comment spam?.

This WordPress anti spam plugin detects automated comment spam to save you the constant nuisance.  It does it without asking your users annoying questions, quizes or reCAPTHCA.
